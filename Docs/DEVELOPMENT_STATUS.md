...
2026-09-24 P16.6 第一轮玩法地形已落地：原型关卡改为 806.4 米单块 Landscape，地形含平原、北侧山脊、西侧小丘、东侧浅谷与蜿蜒河床。营地和围栏位于南侧，12 匹野马在北侧 Habitat 范围内确定性分布；中间有浅河减速区域，东侧硬地路线与岩石，西侧稀疏树木可供绕路和绳索弯折。3,184 个无碰撞 HISM 草实例贴合 Landscape，材质持续风摆并按距离裁剪。上坡、下坡、硬地与浅水均已连接现有 Horse Movement；骑乘进入浅水时反馈层改为水面蹄声并停止扬尘，水花 Niagara 留有资产插槽。P16.6 总览 Smoke、27 项自动化与编辑器完整捕获→自然牵行至少 300 cm→交付→命名 Smoke 通过。Win64 Shipping Build/Cook/Stage/Archive 成功，Cook 为 0 error / 0 warning；Shipping 可执行文件启动 Smoke 正常退出并生成 9 秒自动轮次记录。试玩 ZIP 为 `Packages/ProjectSTEPPE-Windows-20260924-1058.zip`，SHA-256 `67D5DBE886633C43BF1E1838468D1EEA383414D728A9CE64D3ADE3058FA70765`。当前仍需玩家实际第三人称从营地往返马群，确认河、坡、树与硬地至少三项真正改变路线选择；草的马蹄扰动及可读度也待近景验收。P16.6 尚未关闭。
