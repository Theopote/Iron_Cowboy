...
当前自动化基线为 **14 passed、0 failed**，其中 1 项有既有 RiderSeat 占位资源回退警告。
...
在引入开放世界、育种、经济、剧情、季节、狼群或多人之前，先为现有完整灰盒闭环加入可感知的个体差异与必要音画，再将节奏调优到 6–10 分钟并通过重复游玩验证。详细范围和执行顺序见 `PROTOTYPE_GDD.md` 与 `DEVELOPMENT_ROADMAP.md`。
